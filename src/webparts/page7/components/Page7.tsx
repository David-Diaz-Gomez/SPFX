...
const Page7: React.FC<IPage7Props> = (props) => {
  ...
  // const [testimonioActual, setTestimonioActual] = useState<any>();
  const [indexTestimonio, setIndexTestimonio] = useState<number>(0);
  ...
  const handleNextSlideFirst = (): void => {
    ...
    if (state.accion === 'popup6') {
      const indexnuevo = indexTestimonio + 1
      if (indexnuevo > testimonios.length - 1) {
        setIndexTestimonio(0);
      } else {
        setIndexTestimonio(indexnuevo);
      }
    }
  ...
  const handlePrevSlideFirst = (): void => {
    ...
    if (state.accion === 'popup6') {
      const indexnuevo = indexTestimonio - 1
      if (indexnuevo < 0) {
        setIndexTestimonio(testimonios.length - 1);
      } else {
        setIndexTestimonio(indexnuevo);
      }
  ...
  const GetTestimonios = async (url: string) => {
  ...
  useEffect(() => {
    const fetchTestimonios = async () => {
      const testimoniosData = await GetTestimonios("https://esricolombia.sharepoint.com/Areas/GH_2/SiteAssets/Bienestar/Beneficios/Becas Myriam Ardila/Becas Myriam Ardila Testimonios.xlsx")
      setTestimonios(testimoniosData);
    }

    fetchTestimonios();
  }, []);
  console.log("este es el indeice de la imagen", indexTestimonio);
  return (
    <>
      <section>
        ...
        <div className={styles.modalBackdrop} onClick={closePopup}>
          <div className={styles.modalContent} onClick={handleModalClick}>
            ...
            <div style={{ width: '100%', height: '100%', overflowY: 'auto' }}>
              {/* Contenido del modal */}
              <img src="https://www.arcgis.com/sharing/rest/content/items/84aa679e450d4db4875798fd6d60fdee/resources/images/widget_2314/1701725064236.png" style={{ width: '100%', height: '32vh' }} alt="Imagen por defecto" />
                    ...
                    <div className={styles.slides2} style={{ transform: `translateX(-${currentSlideFirst * 100}%)` }}>
                          ...
                          <div style={{ width: '100%', height: '100%' }}>
                            <div style={{ display: 'flex', height: '50%', justifyContent: 'space-between', marginBottom: '5px' }}>
                              <div style={{ width: '17%', position: 'relative' }}>
                                ...
                                />
                                <div className={styles.title_P} style={{ position: 'absolute', bottom: 0, backgroundColor: "rgba(0, 0, 0, 0.46)", color: 'white', textAlign: 'center', width: '100%' }}>
                      ...
                      <div className={styles.slide2}>
                        <div style={{ height: '100%', width: "100%" }}>
                          {/* Segundo slide */}
                          <div className={styles.slide2} style={{ height: '100%', width: "100%" }}>
                            <div style={{ height: '100%', width: "100%" }}>

                              <div style={{ width: '100%', height: '100%', display: "flex", justifyContent: "center", alignItems: "center" }}>

                                <div style={{ width: '55%', height: '100%', margin: 'auto', overflow: "hidden" }}>
                                  <div className={`${styles.slider2andContainer} ${styles.firstSlider}`}>
                                    <div className={styles.slides2} style={{ transform: `translateX(-${currentSlideGallery * 100}%)` }}>
                                      ...
                                      {galeria.map((imagen, index) => {
                                        return (
                                          <div className={styles.slide2} style={{display:"flex",justifyContent:"center",alignItems:"center"}}>
                                            <img
                                              alt={"Image " + index}
                                              src={imagen}
                                              className={styles.imguni2} style={{ width:'auto',}}
                                            />
                                          </div>
                                        );
                                      })}
        ...
        <div className={styles.modalBackdrop} onClick={closePopup}>
          <div className={styles.modalContent} onClick={handleModalClick}>
            ...
            <div style={{ width: '100%', height: '100%', overflowY: 'auto' }}>
              ...
              <div style={{ height: '65vh', display: 'flex' }}>
                <div style={{ width: '30%' }}>
                  {testimonios && modalTab == "testimonios" ? (

                    <img src={testimonios[indexTestimonio].URL_IMG} alt="Imagen por defecto" style={{ width: '100%', height: '100%' }} />
                  ) : (
                    <img src="https://www.arcgis.com/sharing/rest/content/items/84aa679e450d4db4875798fd6d60fdee/resources/images/widget_415/1692047341530.png" alt="Imagen por defecto" style={{ width: '100%', height: '100%' }} />
                  )}
                </div>
                <div style={{ width: '70%', borderLeft: "solid 1px rgb(50, 158, 144)", paddingLeft: "30px" }}>
                  ...
                  <div className={styles.modalTabs}>
                    ...
                    <div
                      className={`${styles.modalTab} ${modalTab === 'testimonios' ? styles.activeTab : ''}`}
                      onClick={() => handleModalTabClick('testimonios')}
                    >
                      Testimonios
                    </div>
                  </div>
                  {
                    modalTab === "testimonios" && (
                      <>
                        {testimonios && (
                          <div className={styles.contentTestimonio}>
                            <div className={styles.contentTestimonioPersona}>
                              ...
                              <p>{testimonios[indexTestimonio].TESTIMONIO}</p>
                            </div>
