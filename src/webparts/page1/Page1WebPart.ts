...
import * as strings from 'Page1WebPartStrings';
import Page1 from './components/Page1';
import { IPage1Props } from './components/IPage1Props';
...
export default class Page1WebPart extends BaseClientSideWebPart<IPage1WebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IPage1Props> = React.createElement(
      Page1,
      {
