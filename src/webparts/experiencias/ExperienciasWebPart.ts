...
import * as strings from 'ExperienciasWebPartStrings';
import Experiencias from './components/Experiencias';
import { IExperienciasProps } from './components/IExperienciasProps';

export interface IExperienciasWebPartProps {
  description: string;
  url1: string;
  url2: string;
  url3: string;
...
export default class ExperienciasWebPart extends BaseClientSideWebPart<IExperienciasWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IExperienciasProps> = React.createElement(
      Experiencias,
      {
